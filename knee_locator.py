...
#This file is merely a copy of the knee_locator file from https://github.com/arvkevi/kneed/blob/master/kneed/knee_locator.py
#This is copied as conda was being difficult with installing the package and this is merely to test if this package is viable as an option
